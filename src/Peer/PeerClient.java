...
public class PeerClient {
    ...
    private final Object HAVE_LOCK=new Object();
    ...
    public synchronized void sendHaveMessageToNeighbors(byte[] pieceInBytes,int pieceIndex){
        synchronized (HAVE_LOCK) {
            file.setPiece(pieceInBytes, pieceIndex);
    ...
    public synchronized boolean allFinished(){
            ...
            synchronized (HAVE_LOCK) {
                ArrayList<Integer> peersNotFinished = new ArrayList<Integer>();
                for (int i = 0; i < neighbors.size(); i++) {
